Get Away Thulla — React Native (Expo) scaffold

This folder contains a production-oriented scaffold for a React Native + Expo TypeScript app designed to implement the Get Away Thulla card game UI/UX and multiplayer architecture.

Quick start

1. Install dependencies (from `rn-getaway` folder):
