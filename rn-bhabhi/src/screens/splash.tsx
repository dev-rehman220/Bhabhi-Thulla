...
export default function SplashScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      <LottieView source={require('~/../../rn-bhabhi/assets/animations/dealing.json')} autoPlay loop={false} style={{ width: 260, height: 260 }} />
      <Text style={styles.title}>Bhabhi Thulla</Text>
    </View>
  );
}
